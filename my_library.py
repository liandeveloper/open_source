...
if __name__== '__main__':
  ...
  if 'repos.csv' not in os.listdir(): init_repos_df.to_csv('repos.csv', index=False, compression='gzip')
  else: print('repos.csv has already been created')
  if 'users.csv' not in os.listdir(): init_users_df.to_csv('users.csv', index=False, compression='gzip')
